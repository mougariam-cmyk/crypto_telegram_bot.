...
# ==========================================
# GROUP COMMUNITY AI REPLY ENGINE — RESTORED DIRECT PATH
# ==========================================
# The original direct Gemini reply path is intentionally restored here.
# Telegram waits for the Gemini response, exactly as in the previous working version.
