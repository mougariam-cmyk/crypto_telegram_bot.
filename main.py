...
FREE_PLAN_AD_TEXT = "\n\n🤖 Powered by MARSOF AI — Affordable AI tools for your crypto project!"

FREE_PLAN_FOOTER_BUTTONS = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("📢 Telegram", url="https://t.me/marsofai"),
        InlineKeyboardButton("🐦 Twitter", url="https://x.com/MARSOF_AI"),
        InlineKeyboardButton("🌐 Website", url="https://marsof.ct.ws"),
...
async def show_public_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("💰 Earn With MARSOF AI", callback_data="menu_partner_promotion"),
            InlineKeyboardButton("🎁 Raffle Simulator", callback_data="menu_raffle")
        ],
        [
        ...
        [InlineKeyboardButton("⚙️ Bot Control Panel", callback_data="menu_edit_existing")],
    ])
    if update.callback_query:
...
async def public_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    feature_titles = {
        ...
        "menu_partner_promotion": "💰 EARN WITH MARSOF AI",
        "menu_raffle": "🎁 RAFFLE SIMULATOR",
...
if __name__ == '__main__':
    ...
    conv_handler = ConversationHandler(
        entry_points=[
            ...
            CallbackQueryHandler(public_menu_handler, pattern='^(menu_launch|menu_language|menu_volume_boost|menu_advertisement|menu_community_management|menu_partner_promotion|menu_raffle|menu_analytics|menu_coin_analyzer|menu_trending|menu_logo_maker|logo_maker_start|menu_website_builder)$'),
