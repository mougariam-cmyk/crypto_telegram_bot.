...
def analyzer_investment_assessment(risks):
    """
    Deterministic market-risk classification for the Analyzer UI.
    This is NOT a personalized investment recommendation. It only classifies
    the currently verified market-risk signals collected by the analyzer.
    """
    ...
    if high:
        return {
            "status": "negative",
            "label": "غير صالحة للاستثمار",
            "emoji": "🔴",
            "reason": "تم رصد عامل أو أكثر من عوامل المخاطر المرتفعة في البيانات المتاحة.",
        }
    ...
    if len(moderate) >= 2:
        return {
            ...
            "label": "غير صالحة للاستثمار",
            "emoji": "🔴",
            "reason": "تم رصد عدة عوامل مخاطر متوسطة في البيانات المتاحة.",
        }

    return {
        "status": "positive",
        "label": "صالحة للاستثمار",
        "emoji": "🟢",
        "reason": "لم يرصد محرك المخاطر الحالي عوامل مرتفعة أو عدة عوامل متوسطة ضمن البيانات المتاحة.",
    }
